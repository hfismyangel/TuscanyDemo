...
<div class="main container">
    ...
    <div class="main-b row">
        <h3 class="text-center main-tab">学生展示</h3>
        <ul class="list-unstyled text-center">
            <div align="center">
                <table align="center">
                    <tr>
                    ...
                    <tr>
                        ...
                        <th width="90" align="center">qq</th>
                        <th width="90" align="center">职业</th>
                        <th width="90" align="center">毕业院校</th>
                        <th width="90" align="center">日报链接</th>
                        <th width="90" align="center">座右铭</th>
                        <th width="90" align="center">推荐人</th>
                        <th width="90" align="center">从何处了解</th>
                    </tr>
                    <c:forEach items="${studentList}" var="Student">
                        <tr>
                            <td width="90" align="center">${Student.id}</td>
                            <td width="90" align="center">${Student.name}</td>
                            <td width="90" align="center">${Student.qq}</td>
                            <td width="90" align="center">${Student.type}</td>
                            <td width="90" align="center">${Student.graduateschool}</td>
                            <td width="90" align="center">${Student.dailynote}</td>
                            <td width="90" align="center">${Student.wish}</td>
                            <td width="90" align="center">${Student.referee}</td>
                            <td width="90" align="center">${Student.knowwhere}</td>
                        </tr>
                    </c:forEach>
                </table>
