...
public class MD5ENcode {
    ...
    public MD5ENcode(Object salt, String algorithm) {
        this.salt = salt;
    ...
    public static void main(String[] args) {
        ...
        boolean passwordValid = encoderMd5.isPasswordValid("58c9216709b079323eff0e01741c2e6b", "123456");
        System.out.println(passwordValid);
        MD5ENcode encoderSha = new MD5ENcode(salt, "SHA");
